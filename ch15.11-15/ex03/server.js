...
function corsMiddleware(_url, _req, res) {
  ...
  res.setHeader("Access-Control-Allow-Origin", "http://localhost:3000");  // credentials が true の場合、ワイルドカードは使えない
  res.setHeader("Access-Control-Allow-Credentials", "true");  // クライアントとセットで設定
