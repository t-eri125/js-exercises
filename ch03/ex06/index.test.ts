import { slice } from "./index.ts"; // javascript で書く場合は "./index.js"

function sliceTestCase(str: string, indexStart: number = 0, indexEnd: number = str.length): [string, number, number, string] {
